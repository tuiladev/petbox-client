 ...
 * Output: "(+84) 337 336 487" hoặc '' nếu không hợp lệ
 */
export const formatPhoneNumber = (phoneNumber) => {
  ...
  // Kiểm tra độ dài: phải đúng 11 chữ số (2 cho mã quốc gia + 9 cho số điện thoại)
  if (cleaned.length !== 11) return phoneNumber
  return `(+${cleaned.substring(0, 2)}) ${cleaned.substring(2, 5)} ${cleaned.substring(5, 8)} ${cleaned.substring(8)}`
}

/**
 * Chuẩn hóa số điện thoại để gửi lên Firebase
 * Input: "(+84) 337 336 487" hoặc "0337336487" hoặc "337336487"
 * Output: "+84337336487" hoặc '' nếu không hợp lệ
 */
